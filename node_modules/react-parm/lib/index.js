...
exports.createPropType = exports.createComponent = exports.createValue = exports.createRenderProps = exports.createRender = exports.createMethod = exports.createElementRef = exports.createComponentRef = exports.createCombinedRef = undefined;
 ...
 */
var createRender = exports.createRender = function createRender(instance, render) {
  return (0, _utils.isClassComponent)(instance) ? (0, _utils.bindSetState)(instance) && function () {
  ...
  } : (0, _utils.logInvalidInstanceError)('render');
};
 ...
 */
var createRenderProps = exports.createRenderProps = function createRenderProps(instance, renderProps) {
  return (0, _utils.isClassComponent)(instance) ? (0, _utils.bindSetState)(instance) && function (props) {
  ...
  } : (0, _utils.logInvalidInstanceError)('render props');
};
 ...
 * @returns {function(...Array<any>): any} the method with the instance passed as value
 */
var createValue = exports.createValue = function createValue(instance, getValue) {
  ...
  return (0, _utils.isClassComponent)(instance) ? (0, _utils.bindSetState)(instance) && getValue.call(instance, instance, extraArgs) : (0, _utils.logInvalidInstanceError)('value');
};
 ...
 */
var createComponent = exports.createComponent = function createComponent(render, options) {
  var _ref = options || {},
  ...
  function ParmComponent(initialProps) {
    ...
    for (var key in options) {
      if (!_utils.IGNORED_COMPONENT_KEYS[key]) {
  ...
  Object.keys(render).forEach(function (staticKey) {
    return !_utils.IGNORED_STATIC_KEYS[staticKey] && (ParmComponent[staticKey] = render[staticKey]);
  });
 ...
 */
var createPropType = exports.createPropType = function createPropType(handler) {
  return (0, _utils.addPropTypeIsRequired)(function (props, key, component, locationIgnored, fullKey) {
    return handler({
      component: component,
      key: key,
